...
platform_req1 =  platform1.get_rect(midbottom = (400,200))
   ...
   #using different stages to play the game (player)
    ...
    if game_active:
        ...
        if scene == 1: 
            ...
            viewable.blit(instruction_1,instruction_1_rect)
        ...
        if scene == 2:
            ...
            viewable.blit(platform1,platform_req1)
            viewable.blit(score,score_rec)
            viewable.blit(player_make,(player_rect))
            ...
            #on platforms  
            if player_rect.colliderect(platform_req1):
                plat  = True
                player_rect.bottom = platform_req1.top
                print(player_rect.y)
                player_gravity -= 1
